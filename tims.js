ratings = [{label:'coffee',price:3,deliciousness:3,speed:5},
          ...
          {label:'french vanilla',price:4,deliciousness:3,speed:2},
          {label:'hot chocolate',price:4,deliciousness:3,speed:4},
          {label:'wraps',price:4,deliciousness:3,speed:5},
        ];
buttonList = [
    { label: 'coffee', text: 'coffee',url:"https://timhortons.ph/upload/assets/Qh4wyZoGLD3N2NWI9t7ShBxSneTBG891VHlHE0I0doPEmACDtW.jpg" },
    { label: 'donuts', text: 'donuts',url: "https://timhortons.co.uk/assets/img/products/5TsvDx4ELFmFZb47VaicwCToMA7JMeN15W2zBryc.jpg"},
    { label: 'french vanilla', text: 'french vanilla',url:"https://m.media-amazon.com/images/I/71u6+dHZFML._AC_UF1000,1000_QL80_.jpg" },
    { label: 'hot chocolate', text: 'hot chocolate' ,url:"https://m.media-amazon.com/images/I/81iktnbpIGL.jpg"},
    { label: 'wraps', text: 'wraps',url:"https://timhortons.co.th/wp-content/uploads/2020/02/Chicken-Bacon-Ranch-Wrap-resize.png" },
  ];
 comments = [
...
function generateBreadcrumbs() {
  ...
  const searchLink = '<a href="search.html">Search</a>';
...
function removeSearchPageOnUnload() {
  window.addEventListener('beforeunload', function () {
    localStorage.removeItem('searchPage');
  });
}
removeSearchPageOnUnload();
