ratings = [{label:'mimosa',price:5,deliciousness:3,speed:5},
          {label:'tacos',price:3,deliciousness:4,speed:5},
          {label:'waffles',price:4,deliciousness:5,speed:2},
          {label:'fish n chips',price:4,deliciousness:5,speed:4},
          {label:'burger',price:4,deliciousness:3,speed:5},
        ];
buttonList = [
    { label: 'mimosa', text: 'mimosa',url:"https://www.simplyrecipes.com/thmb/qGEa2pCB4iVrUyWPWlKHlrE7xyI=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/__opt__aboutcom__coeus__resources__content_migration__simply_recipes__uploads__2014__04__eggs-mimosa-vertical-a-1600-ec234d828a1144ef9e29ac43ef76a21f.jpg" },
    { label: 'tacos', text: 'tacos',url: "https://i0.wp.com/www.onceuponachef.com/images/2023/08/Beef-Tacos.jpg?resize=760%2C570&ssl=1"},
    { label: 'waffles', text: 'waffles',url:"https://cravinghomecooked.com/wp-content/uploads/2019/02/easy-waffle-recipe-1-16.jpg" },
    { label: 'fish n chips', text: 'fish n chips' ,url:"https://www.thespruceeats.com/thmb/k8Ejnb3LR7yrhwGirJEC2x6r1sg=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/best-fish-and-chips-recipe-434856-Hero-5b61b89346e0fb00500f2141.jpg"},
    { label: 'burger', text: 'burger',url:"https://www.thecookierookie.com/wp-content/uploads/2023/04/featured-stovetop-burgers-recipe.jpg" },
  ];
 comments = [
  {label:'mimosa',comments:["Weeb_Azz: OMG, I love sushi","Joseph_Alt: I love this place's sushi","Japanese_Food_Critic: 5/10 had better"]},
  {label:'tacos',comments:["The_Seventh_Hokage: Can't compete agaisnt ramen guy","Kebin_Kaslana: Real nostalgia eating this","Boruto's_Grandpa: My son always goes here"]},
  {label:'porridge',comments:["Insufferable_dude: Ramen's better","Noodlez: slurp slurp slurp","Anime_Boy: Had my first date here eating this"]},
  {label:'fish n chips',comments:["Ichiban_Kasuga: Had this before going away for 20 years","Dragon_Of_Dojima: Kamurocho's beef bowl is the best","Salary_man: always have this after work"]},
  {label:'burger',comments:["Tojo_Clan_Peon: Kinda expensive for someone like me","Takayuki_yagami: I always eat this after a day of work","Masaharu_Kaito: My collegue and I always eat this after a day of work"]},
];
